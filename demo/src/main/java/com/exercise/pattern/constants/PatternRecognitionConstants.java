...
public class PatternRecognitionConstants {
    ...
    //get lines
    public static final String GET_LINES_LOW_P = "There must be at least 2 points in the plane.";
    public static final String GET_LINES_LOW_N = "N must be greater than 1.";
    public static final String GET_LINES_1 = String.join(Strings.EMPTY, GET_LINES_LOW_N, " Mathematically infinite lines pass through one point if at least one exists in the plane.");
    public static final String GET_LINES_OK = "There is/are %s lines which pass through at least %s points in the plane.";
    ...
    //other
    public static final String INDEX_N = "Line n. %s:  %s";
